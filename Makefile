...
ifeq ($(NO_IDE),run)
	...
	DEFAULT_BUILD_DIR := $(DEFAULT_DEBUG_DIR)
...
.PHONY: all clean
clean:
	rm -rf $(DEFAULT_BUILD_OBJ_DIR) $(DEFAULT_BUILD_DIR) $(DEFAULT_DEBUG_DIR) $(PROJECT_DIR)/$(BUILD_DIR_NAME) $(PROJECT_DIR)/$(DEBUG_DIR_NAME)
